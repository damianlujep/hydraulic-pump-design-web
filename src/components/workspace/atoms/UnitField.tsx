...
export const UnitField = forwardRef<HTMLInputElement, UnitFieldProps>(
  ({ unit, error = false, widthPx = 150, className = "", style, inputMode = "decimal", ...props }, ref) => {
    return (
      <span
        className={cn(
          "inline-flex items-center flex-none rounded-[6px] overflow-hidden border bg-surface-3",
          error
            ? "border-danger shadow-[0_0_0_2px_var(--danger-ring)] focus-within:border-danger focus-within:shadow-[0_0_0_2px_var(--danger-ring)]"
