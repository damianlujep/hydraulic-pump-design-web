...
function Icon({ size = 16, strokeWidth = 2, children, ...props }: IconProps & { children: React.ReactNode }) {
  return (
    <svg
      width={size}
      height={size}
...
export function ChevronRightThinIcon(props: IconProps) {
  return (
...
export function DiameterIcon(props: IconProps) {
  return (
    <Icon strokeWidth={2.2} {...props}>
...
export function CheckThinIcon(props: IconProps) {
  return (
