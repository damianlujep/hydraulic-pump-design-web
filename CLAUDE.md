...
- **`src/context/ReactQueryProvider.tsx`** — the `QueryClientProvider` (with devtools), mounted inside `ThemeProvider` in `layout.tsx`. `staleTime: 30_000`, `retry: false`.
